...
function wr_ferado_google_fonts( $fonts = null ) {
	$fonts = array(
		'ABeeZee'                  => 'ABeeZee',
		'Abel'                     => 'Abel',
...
function wr_ferado_standard_fonts( $fonts = null ) {
	$fonts = array(
...
if ( ! function_exists( 'wr_ferado_enqueue_google_fonts' ) ) {
	...
	add_action( 'wp_enqueue_scripts', 'wr_ferado_enqueue_google_fonts' );
}